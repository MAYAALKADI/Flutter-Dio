...
class ClothesProductsScreen extends StatefulWidget {
  @override
  _ClothesProductsScreenState createState() => _ClothesProductsScreenState();
}

class _ClothesProductsScreenState extends State<ClothesProductsScreen> {
  int _selectedIndex = 0;
  String searchQuery = '';
  List<Map<String, dynamic>> favoriteItems = [];

  final List<Map<String, dynamic>> items = [
    {'name': 'HandBag', 'price': 255, 'image': 'images/clothe1.jpg'},
    {'name': 'Watch', 'price': 180, 'image': 'images/cloth2.jpg'},
    {'name': 'Solar Hat', 'price': 550, 'image': 'images/clothe3.jpg'},
    {'name': 'Shoes', 'price': 120, 'image': 'images/clothe4.jpg'},
    {'name': 'Sweater', 'price': 300, 'image': 'images/clothe5.jpg'},
    {'name': 'Bag', 'price': 95, 'image': 'images/clothe6.jpg'},
  ];
